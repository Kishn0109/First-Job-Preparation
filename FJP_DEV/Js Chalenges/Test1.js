// // < --------------Question 1-----------------> I have to learn on It 

// let randomValue = { name: "Lydia" };
// randomValue = 23;
// console.log(!typeof randomValue ) //ye false dega or isko String se compair krne pr bhi false dega 
...
// A: It's not a string! {*}
// B: Yay it's a string! {^} It is correct
// C: TypeError
// D: undefined
...
// fruit.slice(0, 1)
// fruit.splice(0, 1)//Removes elements from an array and, if necessary, inserts new elements in their place, returning the deleted elements.
